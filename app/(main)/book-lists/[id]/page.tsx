...
export default async function BookListPage({ params }: PageProps) {
  const { id } = await params;
  try {
    const list  = await getBookListData("mmmm");
    console.log(list)
    ...
    return (
        <div className="min-h-screen bg-background">
         <div className="container mx-auto px-4 py-8">
           {/* Navigation */}
           <div className="mb-6">
             <Link href="/lists" className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground transition-colors">
           ...
           <div className="w-full max-w-4xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-6">
               ...
               {list.list_books.length === 0 ? (
                ...
                <div className="space-y-8">
                  {list.list_books.map((elem, index) => {
                                  ...
                                  <HoverCardContent>
                                    <div className="bg-background border rounded-lg p-3 shadow-lg">
                                      ...
                                      <p className="text-xs text-muted-foreground mb-2">
                                        Help us speed up the process by providing information about this book.
                                      </p>
                                      <Button
                                        size="sm"
                                        variant="outline"
                                        onClick={() => alert(`Add information about: ${book.name}`)}
                                      >
                                        Add Details
                                      </Button>
                                    </div>
            ...
            <div className="text-xs text-muted-foreground bg-muted/30 p-4 rounded-lg">
              <p>
                <strong>DISCLAIMER:</strong> The books and novels listed on this page are not owned by us.
                This list is intended for recommendation and discovery purposes only.
                All rights and ownership of the content belong to their respective authors and publishers.
              </p>
            </div>
          </div>
        </div>
...
//             <div className="flex flex-col gap-4 items-start mb-8">
//               <h1 className="text-4xl font-bold text-foreground capitalize">
//                 {listDetails.name || "this is a name"}
//               </h1>
...
//               <div className="flex items-center justify-between mb-6">
//                 <h2 className="text-2xl font-semibold">
//                   Books in this list ({novels.length})
//                 </h2>
//               </div>
